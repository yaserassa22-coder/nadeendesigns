-- 039_storefront_experience_checkout_only.sql
-- Sprint 2A MASTER Final: Product Experience on PDP never collects
-- order options / delivery / order notes (checkout-only).
-- Updates system templates. Safe to re-run.

-- Gift template — personalization off; services + gift + summary only
