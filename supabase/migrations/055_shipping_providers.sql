...
-- Idempotent. Run in Supabase SQL Editor if the migration runner is not used.
...
-- No public SELECT. Checkout still uses shipping_regions.
...
-- ---------------------------------------------------------------------------
-- shipping_rates (future checkout; unused by current shipping_regions fees)
-- ---------------------------------------------------------------------------
