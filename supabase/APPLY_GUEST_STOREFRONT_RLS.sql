-- APPLY_GUEST_STOREFRONT_RLS.sql — Phase G2 guest storefront RLS (standalone paste)
-- Same as: supabase/migrations/032_guest_storefront_rls.sql
-- Prefer APPLY_ALL.sql section 35 on fresh setups. Safe to re-run.
-- Requires guest_customers / guest_carts (031 / APPLY_GUEST_CUSTOMERS).
